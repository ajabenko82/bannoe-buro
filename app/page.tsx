...
const masters = [
  {
    ...
    text: "Дмитрий Широков - это глубокий банный релакс — состояние, когда сознание словно растворяется в тепле, аромате и покое. Дмитрий — мастер с большим опытом, безупречным чувством такта и вниманием к каждой детали. В его авторских программах традиции русской бани переплетаются с древними практиками энергетического очищения, помогая восстановить внутреннюю гармонию, вернуть силу и почувствовать себя настоящим.",
  },
  {
    name: "Александр Михель",
    role: "Архитектор ритуала",
    image: "/images/team/alexander.jpg",
    text: "Александр Михель - с первых минут рядом с ним хочется расслабиться и довериться. Спокойный, внимательный, уверенный и очень веселый — он не просто банщик, он настоящий гуру! Называть Александра банщиком или пармастером — значит сильно упростить суть. Он — мастер ритуала, художник, создающий уникальное банное действие. Каждый его сеанс — это тонко выстроенный, персональный обряд, в котором гость становится главным героем волшебного танца пара, аромата и тепла.",
  },
  {
    name: "Алексей Аверьянов",
    role: "Проводник состояния",
    image: "/images/team/alexey.jpg",
    text: "Аверьянов Алексей - мастер банного искусства с многолетним опытом и по-настоящему тонким подходом. Он чутко улавливает настроение и состояние каждого гостя, создавая атмосферу полного доверия, покоя и радости. В команде мы зовем его не иначе как Алексей-шаман — за его особое умение превращать баню в глубинный ритуал восстановления. Его арсенал — это целая коллекция авторских приёмов и лучших техник парения, собранных за долгие годы банной практики. С бережностью и вниманием он проведёт вас к состоянию внутренней тишины, ясности и гармонии с собой.",
  },
];
...
const ritualItems = [
  ...
  {
    title: "Подготовка и уборка пространства",
            ...
            <div className="mt-10 max-w-2xl space-y-12 text-[#5b5044]">
              <div>
                ...
                <div className="mt-6 space-y-5 text-lg leading-8">
                  ...
                  <p>
                    Мы заранее подготавливаем баню, выводим её на рабочий
                    режим, готовим веники, травяные отвары и всё необходимое
              ...
              <div>
                ...
                <div className="mt-6 space-y-6 text-lg leading-8">
                  ...
                  <p>
                    ...
                    живое общение, парение и атмосфера отдыха.
                  </p>
                  <p>
                    <span className="block text-[#201b15]">
                      Деловые партнёры
                  ...
                  <p>
                    ...
                    Восстановление после интенсивной работы, командные
                    мероприятия и отдых для сотрудников.
                  </p>
                  <p>
                    <span className="block text-[#201b15]">
                      Частные ретриты
              ...
              <div>
                ...
                <div className="mt-6 space-y-5 text-lg leading-8">
                  <p>
                    Каждая программа создаётся индивидуально. Мы адаптируем
                    сценарий парения, продолжительность ритуала, массажные и
                    SPA-практики под ваши пожелания, формат встречи и состояние
                    гостей.
                  </p>
                  <p>
                    На каждое мероприятие выезжает полноценная команда из трёх
                    мастеров, что позволяет обеспечить высокий уровень сервиса,
                    внимание к каждому гостю и безупречную организацию всего
                    процесса.
                  </p>
                </div>
              </div>
          ...
          <div className="grid gap-20 lg:grid-cols-[0.72fr_1.28fr]">
            ...
            <div className="reveal max-w-3xl">
              ...
              <div className="mt-12 space-y-6 text-xl leading-9 text-[#5b5044]">
                ...
                <p>
                  Для проведения банного дня мы предоставляем всё необходимое:
                  веники, травяные отвары, текстиль для парения, чайную
                  церемонию и аксессуары для банных ритуалов, чтобы вы могли
                  полностью сосредоточиться на отдыхе и общении с гостями.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-[0.95fr_1.05fr]">
              ...
              <div className="p-8 sm:p-12 lg:p-16">
                ...
                <p className="mt-16 max-w-2xl text-2xl leading-10 text-[#3f352b]">
                  Расскажите о вашем запросе, желаемой дате и формате отдыха.
                  Мы подготовим индивидуальную программу и предложим наиболее
                  подходящий сценарий банного ритуала.
                </p>
                <div className="mt-20 grid gap-4 sm:grid-cols-2">
                  <a
                    href="https://t.me/dmitriySimplydmitriy"
                    target="_blank"
